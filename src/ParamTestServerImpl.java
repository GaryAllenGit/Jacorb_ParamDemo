...
public class ParamTestServerImpl extends MyServerPOA {

	public void op1(String a1, stringSeqHolder/*out*/ s) {
	...
	public void stringCubeInOut(stringCubeHolder/*inout*/ sc) {
		...
		for( int outer = 0; outer < string_cube.length; outer++ ) {
			for( int middle = 0; middle < string_cube[outer].length;
				 middle++ ) {
				for( int inner = 0; inner < string_cube[outer][middle].length;
					 inner++ ) {
